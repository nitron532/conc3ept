...
// alterNode methods shouldnt actually modify db, since these changes should only affect the lesson plan

  const deleteNode = (node) =>{

    //remove from baseNodes, concept map should refresh (shouldnt affect the actual basenodes from db or parent concept map)
  }
